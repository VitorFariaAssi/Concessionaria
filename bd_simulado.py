    ...
    def carregar_carros(self):
        if os.path.exists('Carros.txt'):
            ...
            for carro in file.readlines():
                ...
                carro = Carro(carro[0].strip().strip('"').strip("'"), carro[1].strip().strip('"').strip("'"), carro[2].strip().strip('"').strip("'"), carro[3].strip().strip('"').strip("'"), c[4].strip().strip('"').strip("'"), c[5].strip().strip('"').strip("'"))
